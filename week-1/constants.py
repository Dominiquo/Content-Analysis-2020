...
REGION_MAP = {'ValparaÃ\xadso': 'Valparaíso',
                      'AysÃ©n': 'Aysen',
                      'Los RÃ\xados': 'Los Ríos',
                      'TarapacÃ¡': 'Trapacá',
                      'BÃ\xado-BÃ\xado': 'Bío-Bío',
                      'AraucanÃ\xada': 'Araucanía',
                      'Magallanes y AntÃ¡rtica Chilena': 'Magallanes y Antártica'}
